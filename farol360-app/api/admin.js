...
- Detalhes e pedidos do cliente: ${d.extras ? d.extras : 'nenhum'} (use como contexto; se houver pedido de comparação, gráfico ou recorte, atenda-o nas seções e tabelas correspondentes, dentro da metodologia)
